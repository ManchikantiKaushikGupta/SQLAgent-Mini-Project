...
## Corpus Check
- 35 files · ~9,099 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 234 nodes · 299 edges · 28 communities (22 shown, 6 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `61041d1f`
...
4. `repair_sql_clause()` - 10 edges
5. `validate_sql_semantics()` - 10 edges
6. `clarify_intent()` - 8 edges
7. `generate_query_plan()` - 8 edges
8. `generate_sql()` - 8 edges
9. `correct_sql()` - 8 edges
10. `get_database_schema()` - 7 edges
...
Cohesion: 0.10
Nodes (27): decide_after_execution(), decide_after_semantic_validation(), decide_after_syntax_validation(), node_clarify_intent(), node_correct_sql(), node_execute_sql(), node_semantic_validate(), node_validate_sql() (+19 more)
...
Cohesion: 0.11
Nodes (18): ChatGoogleGenerativeAI, node_sql_generation(), get_llm(), str, Returns a configured ChatGoogleGenerativeAI instance.      Args:         model:, QueryPlan, str, Any (+10 more)

### Community 3 - "Community 3"
Cohesion: 0.27
Nodes (8): bool, str, get_matched_vague_terms(), is_ambiguous(), Intent Clarification Agent  Detects and resolves ambiguous natural language quer, Checks whether a user query contains vague or ambiguous terms     that need clar, Returns a list of vague/ambiguous terms found in the query.      Args:         q, Intent Clarification Agent package.
...
Cohesion: 0.11
Nodes (20): Any, BaseModel, node_query_planning(), LangGraph State Definition  Represents the memory passed between nodes during ex, SQLAgentState, QueryPlan, str, generate_query_plan() (+12 more)
...
## Knowledge Gaps
- **65 isolated node(s):** `int`, `str`, `str`, `float`, `ChatGoogleGenerativeAI` (+60 more)
...
- **Why does `get_llm()` connect `Community 2` to `Community 0`, `Community 8`, `Community 3`, `Community 23`?**

...
## Summary
- 734 nodes · 1236 edges · 62 communities (54 shown, 8 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 145 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c9ae90ce`
...
5. `BenchmarkCase` - 21 edges
6. `OllamaProvider` - 21 edges
7. `VLLMProvider` - 21 edges
...
Cohesion: 0.06
Nodes (58): decide_after_execution(), decide_after_semantic_validation(), decide_after_syntax_validation(), node_clarify_intent(), node_correct_sql(), node_execute_sql(), node_query_planning(), node_retrieve_schema() (+50 more)
...
Cohesion: 0.10
Nodes (22): get_llm(), BaseChatModel, float, str, Returns a configured LangChain ChatModel instance from the active provider., LangGraph State Definition  Represents the memory passed between nodes during ex, QueryPlan, str (+14 more)
...
Cohesion: 0.15
Nodes (12): Architecture Philosophy, Current Architecture, Current Maturity, Current Project Status, DO, DO NOT, Enterprise Architecture Vision, Final Vision (+4 more)
...
Cohesion: 0.12
Nodes (19): Any, str, Structured response representing the semantic correctness verification of a gene, SemanticValidationResult, MockAIMessage, str, Mock of LangChain AIMessage response., Verify that a missing filter literal triggers a rule violation warning alert. (+11 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (66): ask_database(), QueryRequest, QueryResponse, FastAPI Routes  Defines endpoints for the SQLAgent application., Takes a natural language query, runs it through the SQLAgent graph,     and retu, BenchmarkResult, BenchmarkSummary, build_workflow() (+58 more)

### Community 28 - "Community 28"
Cohesion: 0.14
Nodes (19): Any, BaseModel, bool, compare_results(), evaluate_execution_accuracy(), normalize_results(), Any, bool (+11 more)
...
Cohesion: 0.29
Nodes (8): Metrics Tracked, Objective, Objective, PRIORITY 2 — Evaluation Framework [COMPLETED], PRIORITY 3 — Semantic Validation, PRIORITY 3 — Semantic Validation [COMPLETED], Status, Status
...
Cohesion: 0.22
Nodes (10): Objective, Objective, Objective, Objective, PRIORITY 4 — Clause-Level SQL Repair, PRIORITY 6 — Observability & Transparency [COMPLETED], Status, Status (+2 more)

### Community 36 - "Community 36"
Cohesion: 0.18
Nodes (13): Datasets, Goal, Goal, Goal, Goal, Metrics, Objective, Objective (+5 more)
...
Cohesion: 0.22
Nodes (10): Error Categories, Goal, Goal, Goal, Objective, Objective, PRIORITY 9 — Formal Error Taxonomy Engine, PRIORITY 9 — Formal Error Taxonomy Engine [COMPLETED] (+2 more)
...
Cohesion: 0.33
Nodes (6): Features, Objective, Objective, Objective, Objective, PRIORITY 11 — Production Governance & Security
...
Cohesion: 0.18
Nodes (26): BaseCallbackHandler, AnthropicProvider, Concrete provider implementation for Anthropic Claude., get_provider(), LLMProviderFactory, load_config(), Any, LLMProvider (+18 more)
...
Cohesion: 0.10
Nodes (17): get_active_callbacks(), Returns the list of active callbacks for the current thread., Anthropic LLM Provider Implementation  Configures ChatAnthropic and handles fall, LLMProvider, Abstract interface defining the contract for provider-agnostic model creation., str, Gemini LLM Provider Implementation  Configures ChatGoogleGenerativeAI and Google, Ollama LLM Provider Implementation  Configures ChatOllama and OllamaEmbeddings f (+9 more)
...
Cohesion: 0.15
Nodes (17): extract_text(), Any, Safely extracts string content from an LLM response or AIMessage.     Handles st, bool, str, Structured response representing the output of the query correction agent., Structured response representing the output of the query correction agent., SQLCorrectionResult (+9 more)
...
## Knowledge Gaps
- **145 isolated node(s):** `int`, `str`, `liveServer.settings.port`, `float`, `BaseChatModel` (+140 more)
...
- **Why does `get_llm()` connect `Community 3` to `Community 0`, `Community 45`, `Community 49`, `Community 50`, `Community 23`, `Community 55`, `Community 24`, `Community 57`, `Community 56`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `LLMProvider` connect `Community 50` to `Community 1`, `Community 45`, `Community 47`, `Community 48`, `Community 49`, `Community 52`, `Community 53`, `Community 54`?**
...
- **Are the 14 inferred relationships involving `BenchmarkCase` (e.g. with `BenchmarkResult` and `BenchmarkSummary`) actually correct?**
  _`BenchmarkCase` has 14 INFERRED edges - model-reasoned connections that need verification._
